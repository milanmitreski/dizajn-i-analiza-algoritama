...
zadatak po jedna odbrana). U slučaju da se jedan domaći zadatak ne odbrani 
uspešno, student gubi pravo na poene sa domaćih zadataka.
2. Kolokvijum (10 poena). Kolokvijum će biti organizovan u toku semestra. 
Na kolokvijumu će se ispitivati grafovski algoritmi.
3. Seminarski rad (20 poena). Temu biraju studenti, uz odobrenje profesora 
...
[milan.mitreski@matf.bg.ac.rs](mailto:milan.mitreski@matf.bg.ac.rs) radi 
dogovora.
